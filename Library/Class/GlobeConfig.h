...
#define PADocumentsPath [NSHomeDirectory() stringByAppendingPathComponent:@"Documents"]
#define PATempCachePath [PADocumentsPath stringByAppendingPathComponent:@"Cache"]
